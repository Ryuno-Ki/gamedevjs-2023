...
import { gameoverSceneComponent } from '../../../../src/client/components/scenes/gameover.js'

chai.use(chaiDom)
const { expect } = chai

describe('gameoverSceneComponent', () => {
  beforeEach(() => {
  ...
  describe('when gameover scene is active', () => {
    it('should render the gameover scene', () => {
      // Arrange
      const state = Object.assign({}, initialState, { activeScene: 'gameover' })

      // Act
      const component = gameoverSceneComponent(document.body, state)
  ...
  describe('when gameover scene is not active', () => {
